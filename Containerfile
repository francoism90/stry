...
RUN apt-get update && apt-get upgrade -y \
    && mkdir -p /etc/apt/keyrings /data \
    && apt-get install -y gnupg curl ca-certificates zip unzip git sqlite3 libcap2-bin libpng-dev python3 dnsutils librsvg2-bin fswatch ffmpeg postgresql-common \
