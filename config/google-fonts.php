...
return [
     ...
     */
    'fonts' => [
        'default' => 'https://fonts.googleapis.com/css2?family=Geist:wght@100..900&display=swap',
        'code' => 'https://fonts.googleapis.com/css2?family=Geist+Mono:wght@100..900&display=swap',
    ],
