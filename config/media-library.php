...
return [
     ...
     */
    'queue_name' => env('MEDIA_QUEUE', 'processing'),
     ...
     */
    'temporary_directory_path' => env('MEDIA_CONVERSION_PATH', storage_path('app/media-library/temp')),
     ...
     */
    'jobs' => [
        'perform_conversions' => Support\MediaLibrary\Jobs\PerformConversionsJob::class,
        'generate_responsive_images' => Support\MediaLibrary\Jobs\GenerateResponsiveImagesJob::class,
    ],
